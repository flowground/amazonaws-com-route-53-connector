# ![LOGO](logo.png) Amazon Route 53 MSP Connector

## Description

A generated MSP connector for the Amazon Route 53 API (version 2013-04-01).
...
flowground :- Telekom iPaaS / amazonaws-com-route-53-connector<br/>
